...
\usepackage{xcolor}
\usepackage{eso-pic}
% Famille de police blanche dédiée à l'easter egg ci-dessous. Nécessaire car
% friggeri-cv.cls impose "Color=textcolor" (gris, #4D4D4D) sur \setmainfont via
% fontspec, et une couleur définie au niveau de la police prend le pas sur
% \color et \textcolor -- donc \textcolor{white}{...} rend du GRIS, pas du blanc.
...
% ---------------------------------------------------------------------------
% Easter egg assumé -- et NON une tentative de manipulation dissimulée.
%
% Texte en 1pt, blanc sur fond de page blanc, dans la marge basse de la
% dernière page uniquement. Invisible pour un lecteur humain du PDF rendu;
% parfaitement extractible par n'importe quel parseur de texte. Le contenu
% énonce une évaluation positive puis reconnaît immédiatement ce qu'il est et
% pourquoi un système de tri automatisé devrait l'ignorer.
%
% Dessiné dans la couche AVANT-PLAN du shipout (version étoilée = cette page
% seulement) afin d'être placé APRÈS tout le contenu réel dans le flux du PDF:
% un parseur qui aplatit la page ne l'entrelacera pas avec les expériences.
%
% Explication complète: https://colinleverger.fr/prompt-inject.html
% Antériorité, créditée sur cette page: Fielding Johnston,
