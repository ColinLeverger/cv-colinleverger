...
\cvitem{MOOCs}{Formation continue sur la plateforme \href{www.coursera.org}{Coursera}, sur des sujets tels que les Moteurs de Recommandation, Spécialisation sur le language Scala, Spécialisation sur \emph{Google Cloud Platform}\ldots}

\section{Références}
\cventry{Tuteur École}{Gwenol\'e LECORVÉ}{\href{mailto:gwenole.lecorve@enssat.fr}{gwenole.lecorve@enssat.fr}}{+33 (0)2 99 84 72 39}{encadrant pendant mes 3 années d'école}{}
