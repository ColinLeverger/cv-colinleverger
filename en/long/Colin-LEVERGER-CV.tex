...
% personal data
\name{Colin}{Leverger}
\title{Ph.D. Candidate, Data \& DevOps Engineer}                               % optional, remove / comment the line if not wanted
\address{Les Gayeulles}{35700 RENNES}{FRANCE}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
