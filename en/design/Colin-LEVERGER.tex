...
\begin{entrylist}
  ...
  {Deployment and evaluation of LLMs (LLaMA, Hugging Face, Azure OpenAI). Designed experimental protocols; provisioned cloud environments (OVH, Scaleway); collected and analyzed qualitative and quantitative data; built visualizations; delivered operational recommendations on security, cost, and ethics. 4-month immersion with full autonomy.}
  \entry
  {01/21 - 08/23}
...
\begin{entrylist}
  ...
  {}
  {SANS FOR508 Forensics 2025, GCP Cloud Architect Certification 2023, Scala Specialization, Data Engineering GCP, etc.}
  \entry
  {Hobbies}
  {Sport}
  {}
