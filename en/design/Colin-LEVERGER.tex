...
\begin{entrylist}
  ...
  \entry
    ...
    {FUN MOOC}
    {Learning fundamental of Big Data, going from Mathematics to Databases.}
\end{entrylist}
...
%    {}
  ...
  \entry
    ...
    {Notable tools}
    {}
    {Scala sbt, Play Framework, Git, Jenkins, Ansible, OpenWatt, Docker, Microsoft Office, texmaker, IntelliJ, MySQL, mongoDB, xampp, SSH, Neo4j, Gephi, Jmeter, Gatling}
  \entry
    {Hobbies}
    {Music}
