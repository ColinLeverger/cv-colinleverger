...
\begin{aside}
  \includegraphics[scale=0.35]{img/white.png}
  \section{Address}
    13th arrondissement
    75013 PARIS
    FRANCE
  ...
  \textbf{Main}:
  \emph{Python}: 3+ years
  \emph{Bash/Unix}: 5+ years
  \emph{Scala/Java}: 4 years
  \textbf{Experienced}:
  \emph{HTML/PHP}: 3 years
  \emph{R}: 2 years
  ...
  \textbf{French}: native
  \textbf{English}: C1+
  \textbf{Danish}: notions
  \textbf{Japanese}: notions
   ~
  \section{Soft skills}
  Autonomy
  Passion
...
\begin{entrylist}
  \entry
    ...
    {Research in the field of Capacity Planning; development of Machine Learning algorithms and study of  Time Series datasets to make predictions in the context of infrastructure performances. Work both in team LACODAM at INRIA and Orange Labs. Published 3 papers in national and international conferences.}
  \entry
    {02/19 - 05/19}
    {Visiting researcher}
    {National Institute of Technology, Tokyo - JAPAN}
    {3 months research experience in NII labs at Tokyo. Work 
    %with Ryota KOBAYASHI 
    in the field of Machine Learning, Time Series, seasonality. Initiate brand new research collaboration. 
  ...
  \entry
    ...
    {88 h as a lab assistant at Université de Rennes 1 and E.N.S.A.I Rennes for license and master students. I created one project subject, where students had to create a terminal application/web scraper in Python 3. \\ \underline{Main subjects}: Python, Scala, Web.}
  \entry
    {09/14 - 08/17}
    ...
    As a final project, I developed some Machine Learning algorithms in the Capacity Planning speciality; use of Scala, Spark, Elasticsearch, Logstash, Kibana, R...}
  \entry
    {02/15 - Now}
    {Systems and network engineer}
    {On my own - FRANCE}
    {Management of my dedicated server. Use of Docker to manage virtual services, Jenkins to do some DevOps and deploy automatically, Ansible to script and configure the server.}
%  \entry
%    {04/14 - 07/14}
%    {Internship}
...
%    {}
  ...
  \entry
    ...
    {Notable tools}
    {}
    {Pandas, numpy, Keras, Scala sbt, Git, Jenkins, Ansible, Docker, Spark, ELK, influxDB}
  \entry
    {Hobbies}
    {Music}
    {}
    {Creation and composition, beatmaking, recording and sound engineering for my own band. We interpret only our original creations, that are available online on streaming services.}
  \entry
    {}
    {Sport}
    {}
    {Ashtanga Yoga, intermediate level. Occasional swimmer. }
\end{entrylist}
\end{document}