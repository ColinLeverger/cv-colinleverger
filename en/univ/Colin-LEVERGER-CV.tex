...
\phone[mobile]{+33~(0)6~33~504~722}                   % optional, remove / comment the line if not wanted
...
\extrainfo{\href{https://www.linkedin.com/in/colinleverger}{LinkedIn: lnkdin.me/cleverger} \\Last updated: mid Oct. 2018}                 % optional, remove / comment the line if not wanted
...
\cventry
	...
	{Rennes - FRANCE}
	{}
	{Research in the field of \emph{Time Series} and \emph{Capacity Planning}; development of \emph{Machine Learning} algorithms and mining of \emph{Time Series} datasets to make predictions/forecasts in the context of \emph{infrastructure performances}. Work both in team LACODAM at INRIA and Orange Labs, respectively under the supervision of Thomas Guyet and Vincent Lemaire.}
...
\cventry
	...
	{Roskilde - DENMARK}
	{}
	{Five months ERASMUS in Denmark in late 2016.\\
    \underline{Main subjects}: Big Data, Design of Services \& of User Interfaces.}  % arguments 3 to 6 can be left empty
...
\cventry
	...
	{Tokyo - JAPAN}
	{}
	{3 months research experience in NII labs at Tokyo. Work with Ryota Kobayashi in the field of \emph{Machine Learning}, \emph{Time Series}, \emph{seasonality}.
	%Initiate brand new research collaboration. 
	Laureate of two mobility grants: ’NII International Internship Program’ and ’Bourse de mobilité internationale 2019 - Région Bretagne’.}
...
\cventry
	...
	{Bruz - FRANCE}
	{}
	{33 h as a lab assistant at E.N.S.A.I for master 2 students. I wrote the project subject, where students had to create a terminal application/web scraper in Python 3. I taught 4 groups of 5 students.}
...
\cventry
    ...
    {Rennes - FRANCE}
    {}
    {Management of my dedicated server. Use of \emph{Docker} to manage virtual services, \emph{Jenkins} to do some \emph{DevOps} and deploy automatically my web-portfolio: \href{http://www.colinleverger.fr}{http://www.colinleverger.fr}, \emph{Ansible} to script and configure the server.}
...
\cventry
    {2014}
    {Certification PHP and MySQL}
    {OpenClassroom}
    {E-learning}
    {}
    {\emph{Building a website using PHP and MySQL.}}
\cventry
    {2014}
    {Keys to becoming a community manager}
    {OpenClassroom}
    {E-learning}
    {}
    {\emph{Skills and methods to manage a community over social networking.}}
...
\cvitem{English}{Level B2 \emph{(Common European Framework of References for Languages) - Independent user}}{}
\cvitem{Danish}{Notions}{}
\cvitem{Japanese}{Notions}{}

\subsection{Computing}
\cvitem{Languages}{Python, Scala, Java, R, Julia, C, HTML/CSS, PHP, JavaScript, Bash/scripting, SQL, NoSQL, \LaTeX}
\cvitem{Paradigms}{Functional, imperative, object-oriented, concurrent programming, real-time programming}
\cvitem{Tools}{Pandas, numpy, Keras, Scala sbt, Git, Jenkins, Ansible, Docker, Spark, ELK, influxDB, OpenStack, texmaker, IntelliJ, MySQL, mongoDB, xampp, SSH, Neo4j, Gephi, Jmeter, Gatling}

\subsection{Interests and Hobbies}
\cvitem{Music}{Creation and composition, beatmaking, recording and sound engineering for my own band.
We interpret only our original creations, that are available online on streaming services.}
\cvitem{Yoga}{Practice Ashtanga Yoga once a week at an intermediate level.}
