...
\photo[80pt][0.4pt]{img/colinleverger}                       % optional, remove / comment the line if not wanted; '64pt' is the height the picture must be resized to, 0.4pt is the thickness of the frame around it (put it to 0pt for no frame) and 'picture' is the name of the picture file
...
\cventry
	{2017 - 2020}
	{Ph.D. student}
	{INRIA/IRISA, Orange Labs and Services, Cesson S\'evign\'e}
	{Rennes - FRANCE}
	{}
...
\cvitemwithcomment{English}{Level B2 \emph{(Common European Framework of References for Languages)}}{Independent user}
