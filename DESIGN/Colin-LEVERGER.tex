...
\begin{entrylist}
  \entry
    ...
    {Studies during 5 months in Denmark for the last year in E.N.S.S.A.T. engineering school.\\ 
...
%    {}
  ...
  \entry
    ...
    {Noteable tools}
    {}
    {Scala SBT, Git, Microsoft Office, texmaker, IntelliJ, Eclipse, Sublime Text, MySQL, mongoDB, Apache, Bash, SSH}
  \entry
    {Hobbies}
    {Music}
